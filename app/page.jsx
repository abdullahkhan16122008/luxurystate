...
export default function Home() {
  ...
  return (
    <>
      <section className="relative h-screen max-sm:h-[130vh] flex flex-col items-center justify-center bg-cover bg-center" style={{backgroundImage: "url('https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=2000&q=80')"}}>
        <div className="absolute inset-0 bg-black/50"></div>
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-4xl md:text-7xl font-bold md:mb-6 mb-5" data-aos='zoom-in'>Find Your Dream Property</h1>
